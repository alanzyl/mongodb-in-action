for (var j = 0; j < 10000; j++) {
    var r1 = Math.random(); // A nice date around year 2000
    var dateFld = new Date(1.5e12 * r1);
    var intFld = Math.floor(1e8 * r1); // A nicely randomized string of around 40 characters
    ...
    doc.arr = [];
    for (var i = 0; i < 16; i++) {
        var r2 = Math.random(); // A nice date around year 2000
